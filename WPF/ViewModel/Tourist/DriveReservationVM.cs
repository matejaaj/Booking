...
{
    public class DriveReservationVM
    {
        ...
        public DriveReservationVM(User loggedUser)
        {
            Tourist = loggedUser;
            InitializeServices();
        ...
        private void InitializeViewModels()
        {
            ...
            FastDriveViewModel = new FastDriveFormViewModel(Tourist, _userService, _vehicleService, _detailedLocationService, _locationService, _driveReservationService);
            GroupDriveViewModel = new GroupDriveFormViewModel(Tourist, _userService, _vehicleService, _detailedLocationService, _locationService, _driveReservationService);
